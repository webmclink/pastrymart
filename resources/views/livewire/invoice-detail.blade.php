<div>
    <div class="mt-20 max-w-screen-xl mx-auto p-4">
        ...
        <form class="w-full mx-auto" wire:submit="store">
            ...
            {{-- <button type="submit" {{ !$acknowledgement ? 'disabled' : '' }}
                class="{{ !$acknowledgement ? 'cursor-not-allowed' : '' }} text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button> --}}
